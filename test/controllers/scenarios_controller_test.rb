...
class ScenariosControllerTest < ActionController::TestCase
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post :create, scenario: { background: @scenario.background, description: @scenario.description, feature_id: @scenario.feature_id }
    end
  ...
  test "should update scenario" do
    patch :update, id: @scenario, scenario: { background: @scenario.background, description: @scenario.description, feature_id: @scenario.feature_id }
    assert_redirected_to scenario_path(assigns(:scenario))
  end
