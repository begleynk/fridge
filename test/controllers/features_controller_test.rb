...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { descripion: @feature.descripion, project_id: @feature.project_id, title: @feature.title }
    end
  ...
  test "should update feature" do
    patch :update, id: @feature, feature: { descripion: @feature.descripion, project_id: @feature.project_id, title: @feature.title }
    assert_redirected_to feature_path(assigns(:feature))
  end
